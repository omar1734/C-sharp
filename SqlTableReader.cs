...
///     Last col -> timestamp
///
/// Aaron Frost - CACI International 2021
/// </summary>
public class SqlTableReader : MonoBehaviour
{
    public string tableName;

    public List<UnityEvent<string>> columnValueMappingEvents = new List<UnityEvent<string>>();
    ...
    {
        string commandString = "SELECT * FROM " + Schema + "." + tableName + " ORDER BY DTG DESC LIMIT 1";
        ...
        // Remove id/primary key and date time. Only need values.
        temp.RemoveAt(0);
        ...
        { 
            columnValueMappingEvents[i].Invoke(temp[i]);
        }
    }
